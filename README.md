...
```bash
pipx install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.8.2/reuleauxcoder-0.8.2-py3-none-any.whl
```

Or use [`uv`](https://docs.astral.sh/uv/) (v0.8.2+):
