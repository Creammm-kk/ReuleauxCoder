...
```bash
pipx install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.9.1/reuleauxcoder-0.9.1-py3-none-any.whl
```

Or use [`uv`](https://docs.astral.sh/uv/):

```bash
uv tool install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.9.1/reuleauxcoder-0.9.1-py3-none-any.whl
```
