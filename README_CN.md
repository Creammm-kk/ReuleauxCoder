...
```bash
pipx install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.8.1/reuleauxcoder-0.8.1-py3-none-any.whl
```

或者使用 [`uv`](https://docs.astral.sh/uv/)（v0.8.1+）：
